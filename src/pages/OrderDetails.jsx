    ...
    (cake) =>
      cake.id === Number(params.id) && (
        <div className="ordered-cake-prices" key={cake.name}>
          <h3>Prices</h3>
          <ul>
            <li> <span> < GiCakeSlice/>  Half Kg :</span> {cake.half_kg.toLocaleString()}cedis</li>
            <li> <span>  < TbCake/>  One Kg :</span>{cake.one_kg.toLocaleString()} cedis</li>
            <li> <span> <SiCakephp/>  Two kg: </span>  {cake.two_kg.toLocaleString()} cedis</li>
            <li> <span> < HiOutlineCake/> Three kg: </span>  {cake.three_kg.toLocaleString()} cedis</li>
            <li>  <span> <GiStairsCake/> Four Kg: </span> {cake.four_kg.toLocaleString()} cedis</li>
          </ul>
        </div>
      )
  );
      ...
      (cake) =>
        cake.id === Number(params.id) && (
          <div className="display-total" key={cake.id}>
            ...
            {totalPrice.toLocaleString()} cedis
          </div>
        )
    );
          ...
          <div className="pick-size" key={cake.id}>
            ...
            >
              ...
              <option value={cake.half_kg}>
                Half kg at {cake.half_kg.toLocaleString()} cedis
              </option>
              <option value={cake.one_kg}>
                One kg at {cake.one_kg.toLocaleString()} cedis
              </option>
              <option value={cake.two_kg}>
                Two kgs at {cake.two_kg.toLocaleString()} cedis
              </option>
              <option value={cake.three_kg}>
                Three kgs at {cake.three_kg.toLocaleString()} cedis
              </option>
              <option value={cake.four_kg}>
                Four kgs at {cake.four_kg.toLocaleString()} cedis
              </option>
            </select>
          </div>
